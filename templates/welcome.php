	...
	<div class="wrap about-wrap">
		<div id="booked-welcome-panel" class="booked-welcome-panel">
			...
			<div class="booked-welcome-panel-intro">
				<h1><?php echo sprintf(esc_html__('Thank you for choosing %s.','overbooked'),'OverBooked'); ?></h1>
                <p><?php echo sprintf(esc_html__('If this is your first time using %s, you will find some helpful "Getting Started" links below. If you just updated the plugin, you can find out what\'s new in the "What\'s New" section below.','overbooked'),'OverBooked'); ?></p>
            </div>
			...
			<div class="booked-welcome-panel-content">
				<div class="booked-welcome-panel-column-container">
					<div class="booked-welcome-panel-column">
						...
						<a class="button" style="margin-bottom:15px; margin-top:0;" href="https://github.com/SurefireStudios/OverBooked" target="_blank"><?php esc_html_e('View on GitHub','booked'); ?>&nbsp;&nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i></a>&nbsp;
